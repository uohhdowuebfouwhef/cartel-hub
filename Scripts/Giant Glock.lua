local Scale = game.Players.LocalPlayer.Character.Torso.Size.X/2*(game.Players.LocalPlayer.Character.Torso:FindFirstChild("ScaleInserted") ~= nil and game.Players.LocalPlayer.Character.Torso:FindFirstChild("ScaleInserted").Scale.Z or 5)*0.8
	...
	if not Down and not DB then
		...
		while Down do
			...
			if not DB then
				...
				Sound.SoundId = "http://www.roblox.com/Asset/?id=573314737" -- 132373574
