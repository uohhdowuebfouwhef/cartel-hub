...
VanDaPlayer.MouseButton1Down:connect(function()
    local function vicc(text)
        if text == "all" or text == "All" or text == "ALL" or text == "aLL" or text == "aLl" then
            for i,v in pairs(game.Players:GetPlayers()) do
                return v.Name
            end
        elseif text == "others" or text == "OTHERS" or text == "Others" or text == "oTHERS" then
            for i,v in pairs(game.Players:GetPlayers()) do
